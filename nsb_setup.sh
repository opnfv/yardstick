...
# http[s]_proxy  handling
# load values from /etc/environment file
# if value from /etc/environment is not empty string
# and environment variable for http[s]_proxy is not set or is set to empty string export value from /etc/environment.
