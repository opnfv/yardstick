...
class TestProxDataHelper(unittest.TestCase):
    ...
    def test_totals_and_pps(self):
        ...
        data_helper = ProxDataHelper(vnfd_helper, sut, pkt_size, 25, TEN_GIGABIT * ONE_GIGABIT_IN_BITS, None)
    ...
    def test___enter__(self):
        ...
        data_helper = ProxDataHelper(vnfd_helper, sut, None, None,
            TEN_GIGABIT * ONE_GIGABIT_IN_BITS,5.4)
...
class TestProxProfileHelper(unittest.TestCase):
    ...
    def test_run_test(self, _):
        ...
        helper.run_test(120, 5, TEN_GIGABIT * ONE_GIGABIT_IN_BITS, 6.5)
...
class TestProxBngProfileHelper(unittest.TestCase):
    ...
    def test_run_test(self, _):
        ...
        helper.run_test(120, 5, 6.5, TEN_GIGABIT * ONE_GIGABIT_IN_BITS)

        # negative pkt_size is the only way to make ratio > 1
        helper.run_test(-1000, 5, 6.5, TEN_GIGABIT * ONE_GIGABIT_IN_BITS)
