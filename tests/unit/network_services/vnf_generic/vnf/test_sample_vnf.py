...
class TestDpdkVnfSetupEnvHelper(unittest.TestCase):
    ...
    @mock.patch.object(six.BytesIO, 'getvalue', return_value='100\n')
    def test__setup_hugepages(self, mock_getvalue, mock_meminfo):
        ...
        with mock.patch.object(sample_vnf.LOG, 'info') as mock_info:
            ...
            mock_info.assert_called_once_with(
                'Hugepages size (kB): 2048, number claimed: 8192, '
                'number set: 100')
