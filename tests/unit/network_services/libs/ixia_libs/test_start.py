...
from yardstick.network_services.libs.ixia_libs.IxNet.start import \
    IxStart


class TestIxStart(unittest.TestCase):
    def test__start_traffic(self):
        ixnet_gen = IxStart()
        ...
        result = ixnet_gen._start_traffic(ixnet)
