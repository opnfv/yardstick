...
from yardstick.network_services.libs.ixia_libs.IxNet.frame_control import \
    IxFrame


class TestIxFrame(unittest.TestCase):
    def test__setup_frame_properties(self):
        ixnet_gen = IxFrame()
        ...
        result = ixnet_gen._setup_frame_properties(ixNet, STATIC_TRAFFIC)
