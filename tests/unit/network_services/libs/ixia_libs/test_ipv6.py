...
from yardstick.network_services.libs.ixia_libs.IxNet.ipv6 import \
    IxIPv6


class TestIxIPv6(unittest.TestCase):
    def test__add_ipv6_header(self):
        ixnet_gen = IxIPv6()

        ixNet = mock.MagicMock()
        ixNet.getList = \
            mock.Mock(side_effect=[[1], [1], [1],
        ...
        result = ixnet_gen._add_ipv6_header(ixNet, STATIC_TRAFFIC)
        self.assertIsNone(result)

    def test__add_ipv6_header_error(self):
        ixnet_gen = IxIPv6()
        ...
        ixNet.setMultiAttribute = mock.Mock(return_value=[1])
        ixNet.commit = mock.Mock(return_value=[1])
        self.assertRaises(StopIteration, ixnet_gen._add_ipv6_header, ixNet, STATIC_TRAFFIC)
