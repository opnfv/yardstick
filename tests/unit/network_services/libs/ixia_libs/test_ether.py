...
from yardstick.network_services.libs.ixia_libs.IxNet.ether import \
    IxEther


class TestIxEther(unittest.TestCase):
    def test__add_ethernet_header(self):
        ixnet_gen = IxEther()
        ...
        result = ixnet_gen._add_ethernet_header(ixNet, STATIC_TRAFFIC)
        self.assertIsNone(result)

    def test__add_ethernet_header_error(self):
        ixnet_gen = IxEther()
