...
if stl_patch:
    ...
    from yardstick.network_services.traffic_profile.prox_bng import ProxBngProfile


class TestProxBngProfile(unittest.TestCase):
    ...
    def test_bng_1(self):
        ...
        profile = ProxBngProfile(tp_config)
