...
class TestProxBinSearchProfile(unittest.TestCase):
    ...
    def test_execute_1(self):
        ...
        result_tuple = {"Result_Actual_throughput": 7.5e-07, "Result_theor_max_throughput": 0.00012340000000000002, "Result_pktSize": 200}
        profile.queue.put.assert_called_with(result_tuple)

        success_result_tuple = {"Success_CurrentDropPackets": 0.5, "Success_DropPackets": 0.5, "Success_LatencyAvg": 5.3,
                                "Success_LatencyMax": 5.2, "Success_LatencyMin": 5.1, "Success_PktSize": 200, "Success_RxThroughput": 7.5e-07,
                                "Success_Throughput": 7.5e-07, "Success_TxThroughput": 0.00012340000000000002}

        calls = profile.queue.put(success_result_tuple)
        profile.queue.put.assert_has_calls(calls, any_order=False)
