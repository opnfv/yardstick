...
from yardstick.network_services.helpers.samplevnf_helper import \
    OPNFVSampleVNF, MultiPortConfig
...
class TestMultiPortConfig(unittest.TestCase):
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test___init__(self, os, SafeConfigParser):
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test___init__error(self, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = "cfg"
        tmp_file = mock.Mock()
        self.assertRaises(ValueError, MultiPortConfig, topology_file, config_tpl, tmp_file)

    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.open')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_update_timer(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_generate_script(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_generate_script_data(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_generate_rule_config(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_generate_action_config(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_generate_arp_config6(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_generate_arp_config(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_get_ports_gateway(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_get_ports_gateway6(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_get_netmask_gateway(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_get_netmask_gateway6(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_generate_link_config(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_generate_config(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    def test_get_absolute_path(self, mock_open, mock_os, SafeConfigParser):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
        ...
        self.assertIsNone(opnfv_vnf.generate_config())
        opnfv_vnf.is_openstack = False
        self.assertIsNotNone(opnfv_vnf.get_absolute_path('filename'))

    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.open')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.os')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_get_config_tpl_data(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_get_txrx_tpl_data(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_init_write_parser_template(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_init_write_parser_template_2(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_update_write_parser(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_get_worker_threads(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_generate_next_core_id(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_generate_lb_to_port_pair_mapping(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_set_priv_que_handler(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_generate_arpicmp_data(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_generate_final_txrx_data(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_generate_lb_data(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_generate_vnf_data(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_generate_config_data(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_get_port_pairs(self, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        ...
        result = opnfv_vnf.get_port_pairs()
        self.assertIsNone(result)
    ...
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.SafeConfigParser')
    @mock.patch('yardstick.network_services.helpers.samplevnf_helper.OrderedDict')
    def test_init_eal(self, mock_open, mock_os, SafeConfigParser,
                                 OrderedDict):
        topology_file = mock.Mock()
        config_tpl = mock.Mock()
        tmp_file = mock.Mock()
        interfaces = [{'virtual-interface': {'vcpi': "05:00.0"}}]
        opnfv_vnf = MultiPortConfig(topology_file, config_tpl, tmp_file)
        opnfv_vnf.socket = 0
        opnfv_vnf.start_core = 0
        opnfv_vnf.port_pair_list = [[[0], [1]]]
