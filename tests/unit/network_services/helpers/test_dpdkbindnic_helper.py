...
class TestDpdkNode(unittest.TestCase):
    ...
    def test_probe_ip_tool(self, mock_ssh):
        mock_instance = mock_ssh()
        mock_instance.execute.return_value = 0, '', ''

        dpdk_node = DpdkNode('key', {"interfaces": {}})

        self.assertIsNone(dpdk_node.probe_ip_tool())

    def test_probe_ip_tool_ssh_negative(self):
        mock_ssh_helper = mock.Mock()
    ...
    def test_probe_netdevs_setup_negative(self):
        ...
        self.assertEqual(dpdk_node.probe_netdevs(), {})
