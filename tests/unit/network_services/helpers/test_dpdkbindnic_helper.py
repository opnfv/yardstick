...
"""
    ...
    def test__addline(self):
        ...
        dpdk_bind_helper._addline(KERNEL, self.ONE_INPUT_LINE)

        self.assertIsNotNone(dpdk_bind_helper.dpdk_status)
        self.assertEquals(self.ONE_INPUT_LINE_PARSED, dpdk_bind_helper.dpdk_status[KERNEL])
    ...
    def test__get_bound_pci_addresses(self):
        ...
        self.assertEquals(['0000:00:04.0', '0000:00:05.0'],
                          dpdk_bind_helper._get_bound_pci_addresses(DPDK))
        self.assertEquals(['0000:00:03.0'],
                          dpdk_bind_helper._get_bound_pci_addresses(KERNEL))
