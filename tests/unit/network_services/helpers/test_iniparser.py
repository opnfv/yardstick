...
class TestYardstickConfigParser(unittest.TestCase):
    ...
    def test_section_set_value_set_all(self):
        ...
        YardstickConfigParser.section_set_value(self.LARGE_SECTION, 'key2', 'value_two', set_all=True)
        self.assertEqual(self.LARGE_SECTION, expected)
    ...
    def test_update_section(self):
        ...
        self.assertIsNone(YardstickConfigParser.update_section_data(input_sections, new_section_data))
