...
class TestCpuModel(unittest.TestCase):
    ...
    def test_allocate(self):
        ...
        self.assertEquals(cpus, None)

        cpus = self.cpu_model.allocate(0)
        self.assertEquals(cpus, CpuList([]))
        ...
        self.assertEquals(str(self.cpu_model.cpu_cores_pool), '6-10')
    ...
    def test_deallocate(self):
        ...
        self.assertEquals(str(self.cpu_model.cpu_cores_pool), '1,2,6-10')
