...
class GetEndpointTestCase(unittest.TestCase):
    ...
    def test_get_endpoint(self, mock_get_session):
        mock_get_session.get_endpoint.return_value('http://172.16.1.222:35357/')
        expected_result = 'http://172.16.1.222:35357/'
        end_point = openstack_utils.get_endpoint(service_type='test')
