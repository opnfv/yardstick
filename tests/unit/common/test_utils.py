...
class TestUtils(unittest.TestCase):
    ...
    @mock.patch('yardstick.common.utils.os.walk')
    @mock.patch('yardstick.common.utils.importutils.import_module')
    def test_import_modules_from_package_import_error(self, mock_import_module, mock_walk):
        mock_import_module.side_effect = [None, ImportError, KeyError]
        mock_walk.return_value = [
        ...
        self.assertGreater(mock_import_module.call_count, 0)
