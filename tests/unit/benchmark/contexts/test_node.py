...
class NodeContextTestCase(unittest.TestCase):
    ...
    def test_init_negative(self):
        ...
        self.assertEqual(read_mock.called, 2)
        self.assertEqual(raised.exception.errno, errno.ENOENT)
        self.assertIn(consts.YARDSTICK_ROOT_PATH, get_error_message(raised.exception))
        ...
        self.assertNotIn(consts.YARDSTICK_ROOT_PATH, get_error_message(raised.exception))
