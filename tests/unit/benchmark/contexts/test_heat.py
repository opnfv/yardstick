...
class HeatContextTestCase(unittest.TestCase):
    ...
    def test_construct(self):
        ...
        self.assertIn(self.test_context, base.Context.list)

    # @mock.patch('yardstick.benchmark.contexts.model.PlacementGroup')
    # @mock.patch('yardstick.benchmark.contexts.model.Network')
    # @mock.patch('yardstick.benchmark.contexts.model.Server')
    ...
    #                                        'private_ip': '10.0.0.1'}
    #     base.Context.list = [self.mock_context]
    #     attr_name = {'name': 'foo.bar',
    #                  'public_ip_attr': 'public_ip',
    #                  'private_ip_attr': 'private_ip'}
    #     result = base.Context.get_server(attr_name)
