...
class OvsDpdkContextTestCase(unittest.TestCase):
    ...
    def test__check_hugepages(self, mock_bytesio):
        data = ('HugePages_Total:      20\n'
                'HugePages_Free:       20\n'
                'HugePages_Rsvd:        0\n'
                'HugePages_Surp:        0\n'
                'Hugepagesize:    1048576 kB')
        mock_meminfo = mock.Mock()
        mock_bytesio.return_value = mock_meminfo
        mock_meminfo.getvalue = mock.Mock()
        mock_meminfo.getvalue.return_value = data
        self.ovs_dpdk.connection = mock.Mock()
    ...
    def test__check_hugepages_no_info(self, mock_bytesio):
        ...
        mock_bytesio.return_value = mock_meminfo
        mock_meminfo.getvalue = mock.Mock()
        mock_meminfo.getvalue.return_value = ''
        self.ovs_dpdk.connection = mock.Mock()
