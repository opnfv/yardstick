...
class ServerTestCase(unittest.TestCase):
    ...
    def test__add_instance(self, mock_template):
        ...
        attrs = {'image': 'some-image', 'flavor': 'flavor1', 'flavors': ['flavor1','flavor2']}
        test_server = model.Server('ServerFlavor', self.mock_context, attrs)

        self.mock_context.flavors =  ['flavor1','flavor2']
        ...
        test_server._add_instance(mock_template, 'ServerFlavor',
                                  [mock_network], 'hints')

        mock_template.add_port.assert_called_with(
            'ServerFlavor-some-network-port',
        ...
        mock_template.add_server.assert_called_with(
            'ServerFlavor', 'some-image',
            flavor='flavor1',
            flavors=['flavor1','flavor2'],
            ports=['ServerFlavor-some-network-port'],
    ...
    def test__add_instance_plus_flavor(self, mock_template):
        ...
        attrs = {'image': 'some-image', 'flavor': 'flavor1', 'flavors': ['flavor2']}
    ...
    def test__add_instance_misc(self, mock_template):
        ...
        mock_template.add_flavor(
            ...
            ram=2048,
            disk=1,
            extra_specs={'cat': 1, 'doc': 2, 'dragon': 1000} )

        mock_template.add_server(
