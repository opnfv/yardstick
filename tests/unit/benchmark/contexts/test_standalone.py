...
class StandaloneContextTestCase(unittest.TestCase):
    ...
    def test_successful_init_sriov(self):
        attrs_sriov = {
            'name': 'sriov',
    ...
    def test_successful_init_ovs(self):
        attrs_ovs = {
             'name': 'ovs',
    ...
    def test__get_server_with_dic_attr_name_sriov(self):
        attrs_sriov = {
            'name': 'foo',
            'file': self._get_file_abspath(self.NODES_SAMPLE)
        }
    ...
    def test__get_server_with_dic_attr_name_ovs(self):
        attrs_ovs = {
            'name': 'foo',
            'file': self._get_file_abspath(self.NODES_SAMPLE_OVSDPDK)
        }
    ...
    def test__get_server_not_found_sriov(self):
        attrs = {
            'name': 'foo',
            'file': self._get_file_abspath(self.NODES_SAMPLE)
        }
    ...
    def test__get_server_not_found_ovs(self):
        attrs = {
            'name': 'foo',
            'file': self._get_file_abspath(self.NODES_SAMPLE_OVSDPDK)
        }
    ...
    def test__get_server_duplicate_sriov(self):
        attrs = {
            'name': 'foo',
    ...
    def test__get_server_duplicate_ovs(self):
        attrs = {
            'name': 'foo',
    ...
    def test__get_server_found_sriov(self):
        attrs = {
            'name': 'foo',
    ...
    def test__get_server_found_ovs(self):
        attrs = {
            'name': 'foo',
    ...
    def test__deploy_unsuccessful(self):
        self.test_context.vm_deploy = False
        

    def test__deploy_sriov_firsttime(self):
        attrs = {
            'name': 'foo',
            'file': self._get_file_abspath(self.NODES_SAMPLE)
        }
    ...
    def test__deploy_sriov_notfirsttime(self):
        attrs = {
            'name': 'foo',
            'file': self._get_file_abspath(self.NODES_SAMPLE)
        }
    ...
    def test__deploy_ovs_firsttime(self):
        attrs = {
            'name': 'foo',
            'file': self._get_file_abspath(self.NODES_SAMPLE_OVSDPDK)
        }
    ...
    def test__deploy_ovs_notfirsttime(self):
        attrs = {
            'name': 'foo',
            'file': self._get_file_abspath(self.NODES_SAMPLE_OVSDPDK)
        }
    ...
    def test_get_nfvi_obj_sriov(self):
    ...
    def test_get_nfvi_obj_ovs(self):
