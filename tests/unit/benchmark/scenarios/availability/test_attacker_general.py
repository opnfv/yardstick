...
# Unittest for yardstick.benchmark.scenarios.availability.attacker.attacker_general
...
@mock.patch('yardstick.benchmark.scenarios.availability.attacker.attacker_general.ssh')
class GeneralAttackerServiceTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.attacker_cfg = {
            ...
            'actionParameter':{'process_name':'nova_api'},
            'rollbackParameter':{'process_name':'nova_api'},
            'key':'attack_001',
            'host': 'node1',
        }
