...
# Unittest for yardstick.benchmark.scenarios.compute.sample.Sample
...
from yardstick.benchmark.scenarios.compute import sample


@mock.patch('yardstick.benchmark.scenarios.compute.sample.ssh')
