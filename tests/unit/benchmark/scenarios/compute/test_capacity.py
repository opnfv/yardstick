...
# Unittest for yardstick.benchmark.scenarios.compute.capacity.Capacity
...
from yardstick.benchmark.scenarios.compute import capacity


@mock.patch('yardstick.benchmark.scenarios.compute.capacity.ssh')
