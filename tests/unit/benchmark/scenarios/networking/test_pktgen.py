...
class PktgenTestCase(unittest.TestCase):
    ...
    def test_pktgen_unsuccessful_get_vnic_type(self, mock_ssh):
        args = {
            'options': {'packetsize': 60},
        }
        p = pktgen.Pktgen(args, self.ctx)
        ...
        self.assertRaises(RuntimeError, p._get_vnic_type)
    ...
    def test_pktgen_multiqueue_setup_no_multiqueue(self, mock_ssh):
        args = {
    ...
    def test_pktgen_multiqueue_setup_not_firsttime(self, mock_ssh):
        args = {
        ...
        self._is_irqbalance_disabled = mock_result
