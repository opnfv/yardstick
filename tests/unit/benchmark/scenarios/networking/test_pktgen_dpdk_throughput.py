...
class PktgenDPDKTestCase(unittest.TestCase):
    ...
    def test_pktgen_dpdk_throughput_successful_dpdk_setup(self, mock_ssh):
        args = {
            'options': {'packetsize': 60},
        }
        p = pktgen_dpdk_throughput.PktgenDPDK(args, self.ctx)
    ...
    def test_pktgen_dpdk_throughput_successful_get_port_ip(self, mock_ssh):
        args = {
            'options': {'packetsize': 60},
        }
        p = pktgen_dpdk_throughput.PktgenDPDK(args, self.ctx)
    ...
    def test_pktgen_dpdk_throughput_unsuccessful_get_port_ip(self, mock_ssh):
        args = {
            'options': {'packetsize': 60},
        }
    ...
    def test_pktgen_dpdk_throughput_successful_get_port_mac(self, mock_ssh):
        args = {
            'options': {'packetsize': 60},
        }
        p = pktgen_dpdk_throughput.PktgenDPDK(args, self.ctx)
    ...
    def test_pktgen_dpdk_throughput_unsuccessful_get_port_mac(self, mock_ssh):
        args = {
            'options': {'packetsize': 60},
        }
