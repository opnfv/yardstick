...
def mocked_requests_post(*args, **kwargs):
    ...
    elif args[0] == "http://StorPerf:5000/api/v1.0/jobs" and args[1] == {"agent_count": "8", "agent_network": "StorPerf_Agent_Network", "volume_size": "10"}:
        return MockResponsePost({"job_id": "100"}, 200)
    elif args[0] == "http://StorPerf:5000/api/v1.0/jobs" and args[1] == "100":
...
class StorPerfTestCase(unittest.TestCase):
    ...
    @mock.patch('yardstick.benchmark.scenarios.storage.storperf.requests.
                delete', side_effect=mocked_requests_delete)
