...
FAKE_DB_TASK = [{'fake_key': 0.000, 'time': FAKE_TIME.decode('utf8')}]
...
class ReportTestCase(unittest.TestCase):
    ...
    def test_task_not_found(self, mock_query):
        ...
        self.assertRaisesRegexp(Exception, "Task ID", self.rep._get_fieldkeys)
        self.assertRaisesRegexp(Exception, "Task ID", self.rep._get_tasks)
