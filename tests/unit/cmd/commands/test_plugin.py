...
# from yardstick.cmd.commands.plugin import PluginCommands
# from yardstick.cmd.commands.plugin import PluginParser


class Arg(object):
    def __init__(self):
        self.inputfile = ('plugin/sample_config.yaml',)
