...
class TestYardstickNSCli(unittest.TestCase):
    ...
    def test_handle_list_options(self):
        ...
        self.assertRaises(SystemExit, yardstick_ns_cli.handle_list_options, args, test_path)
    ...
    def test_run_test(self):
        ...
        test_path = os.path.join(YARDSTICK_REPOS_DIR, "../samples/vnf_samples/nsut/")
        yardstick_ns_cli = YardstickNSCli()
        subprocess.check_output = mock.Mock(return_value=0)
        args = {"vnf": "vpe", "test": "tc_baremetal_rfc2544_ipv4_1flow_1518B.yaml"}
        ...
        args = []
        self.assertEqual(None, yardstick_ns_cli.run_test(args, test_path))
        os.chdir(YARDSTICK_REPOS_DIR)

    def test_terminate_if_less_options(self):
        yardstick_ns_cli = YardstickNSCli()
        args = {"vnf": False}
        self.assertRaises(SystemExit, yardstick_ns_cli.terminate_if_less_options, args)
