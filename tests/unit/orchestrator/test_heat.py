...
class HeatTemplateTestCase(unittest.TestCase):
    ...
    def test__add_resources_to_template_raw(self):
        ...
        self.tmpfile = NamedTemporaryFile(delete=False, mode='w+t')
        self.tmpfile.write("heat_template_version: 2015-04-30")
        self.tmpfile.close()
        self.heat_tmp_template = heat.HeatTemplate(self.heat_tmp_object, self.tmpfile.name,
