...
class HeatTemplateTestCase(unittest.TestCase):
    ...
    @mock.patch('yardstick.common.openstack_utils')
    def test_create(self, mock_heat_client_class, mock_op_utils):
        ...
        with mock.patch.object(self.template, 'status', return_value=None) as mock_status:
            ...
            self.assertEqual(mock_heat_client_class.call_count, 1)
            ...
            self.assertEqual(mock_heat_client_class.stacks.create.call_count, 1)
