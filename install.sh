...
echo -e "deb [arch="${DOCKER_ARCH}"] "${DOCKER_REPO}" $VERSION_CODENAME universe
deb [arch="${EXTRA_ARCH}"] "${EXTRA_REPO}" $VERSION_CODENAME main universe multiverse restricted
deb [arch="${EXTRA_ARCH}"] "${EXTRA_REPO}" $VERSION_CODENAME main universe multiverse restricted
deb [arch="${EXTRA_ARCH}"] "${EXTRA_REPO}" $VERSION_CODENAME main universe multiverse restricted
deb [arch="${EXTRA_ARCH}"] "${EXTRA_REPO}" $VERSION_CODENAME main universe multiverse restricted" > "${sub_source_file}"
