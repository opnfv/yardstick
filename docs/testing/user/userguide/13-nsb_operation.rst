...
.. code-block:: console
  ...
  yardstick --debug task start --task-args='{"mem": 10480, "vcpus": 4, "ports": 2}'   samples/vnf_samples/nsut/vfw/tc_heat_rfc2544_ipv4_1rule_1flow_64B_trex_scale-up.yaml
 In order to support ports scale-up traffic profiles and topology templates needs to be used in testcase.
...
This template has "vports" as an argument. To pass this agreement it needs to be configured in "extra_args" scenario definition. Please none that more argument can be defined in that section. All of them will be passed to topology and traffic profile templates
