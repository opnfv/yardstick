...
.. note::
   ...
   Yardstick may not be operational after linux kernel update  if
   it has been installed before. Run ``nsb_setup.sh`` again in
   this case.
...
.. note::
   ...
   character length. As an example can be used following command:
