...
In this context sample VNFs are running inside a VM. This VM can be deployed
manually or using Yardstick. If parameter *vm_deploy* is set to `True` VM will
be deployed by Yardstick. Otherwise VM should be deployed manually.
Test case example, context section::
