...
1. Get a certain released test case's information;
...
1. Get a certain test suite's information;
2. Delete a test case.
...
1. Get a certain project's information;
2. Delete a project.
...
1. Get a certain container's information;
