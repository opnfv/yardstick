...
This can be auto generated or a file can be passed using the  script_file option in
vnf_config as seen below. The full_tm_profile_file: must be used if a traffic manager
is defined in vpe_config
