...
.. include:: code/single-devstack-local.conf
   :code: console
...
.. include:: code/single-yardstick-pod.conf
   :code: console
...
.. include:: code/multi-devstack-controller-local.conf
   :code: console
...
.. include:: code/multi-devstack-compute-local.conf
   :code: console
