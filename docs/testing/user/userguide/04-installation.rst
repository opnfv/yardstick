...
save OpenStack environment variables in it. If you have your openstack credential file saved outside the Yardstcik Docker container,
you can do this by easily mapping the credential file into Yardstick container using '-v /path/to/credential_file:/etc/yardstick/openstack.creds' when running the Yardstick container.
