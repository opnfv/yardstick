...
|              | traffic.                                                          |
|              |                                                                   |
|              | This test allows to check processing capability under different   |
|              | levels of load (number of subscriber, generated traffic           |
...
|              | * Establish the subscribers connections to EPC network (default   |
|              |   bearers);                                                       |
|              | * Establish the number of dedicated bearers as per per default    |
|              |   bearer for each subscriber;                                     |
