...
average between approx. 170 and 185 GB/s. Within each test run the results
vary, with a minimum of 2KB/s and maximum of 690KB/s on the totality. Most
runs have a minimum BW of 3KB/s (one run at 2 KB/s). The maximum BW varies
more in absolute numbers between the dates, between 560 and 690 KB/s.
