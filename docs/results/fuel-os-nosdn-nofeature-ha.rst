...
average at approx. 160-170 GB/s. Within each run the results vary much,
minimum 2KB/s and maximum 630KB/s on the totality. Most runs have a
minimum of 3KB/s (one run at 2 KB/s). The maximum BW varys much more in
absolute numbers, between 566 and 630 KB/s.
...
17,7 GB/s. Within each run the results vary, with aminimal BW of 15.4
