...
|              |                                                              |
|              | The benchmarks developed for block and object storage will be|
|              | sufficiently varied to provide a good preview of expected    |
...
|              |     - VM has internet connectivity for downloading the docker|
|              |        image                                                 |
|              |     - Enough floating IPs must be available to match your    |
|              |       agent count                                            |
|              |                                                              |
