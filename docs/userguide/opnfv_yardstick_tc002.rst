...
.. _mam_page: https://linux.die.net/man/8/ping
...
|              |                                                              |
+--------------+--------------------------------------------------------------+
|applicability | This test case can be configured with different packet       |
|              | sizes, burst sizes, ping intervals, test durations and test  |
|              | iterations.                                                  |
|              |                                                              |
