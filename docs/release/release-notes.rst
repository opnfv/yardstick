...
* Test cases for the Virtual Traffic Classifier - virtual Traffic Classifier
is part of the Yardstick_ Project.
...
|                             |                                               |
+-----------------------------+-----------------------------------------------+
|  file.py                    | Log to a file.                                |
|                             |                                               |
+-----------------------------+-----------------------------------------------+
|  http.py                    | Post data to html.                            |
|                             |                                               |
+-----------------------------+-----------------------------------------------+
|  influxdb.py                | Post data to influxdB.                        |
|                             |                                               |
+-----------------------------+-----------------------------------------------+
|  influxdb_line_protocol.py  | Line protocol is used for influxdB.           |
|                             |                                               |
+-----------------------------+-----------------------------------------------+
...
* Test Case for OPNFV Parser Project:
  ...
  * OPNFV_YARDSTICK_TCO40 - Verufy Parser Yang-to-Tosca

* Test Cases for virtual Traffic Classifier:

  * OPNFV_YARDSTICK_TCOO6 - Virtual Traffic Classifier Data Plane Thruoghput
    Benchmarking Test

  * OPNFV_YARDSTICK_TCOO7 - Virtual Traffic Classifier Data Plane Throughput
    Benchmarking Test in Presence of Noisy Neighbors

  * OPNFV_YARDSTICK_TCO20 - Virtual Traffic Classifier Instantiation Test

  * OPNFV_YARDSTICK_TCO21 - Virtual Traffic Classifier Instantiation Test in
