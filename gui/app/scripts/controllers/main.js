...
angular.module('yardStickGui2App')
    .controller('MainCtrl', ['$scope', '$state', '$stateParams', 'mainFactory', 'Upload', 'toaster', 'ngDialog', '$localStorage', '$loading',
            ...
            function uploadFilesPod($file, $invalidFiles) {
                ...
                Upload.upload({
                    ...
                    if (response.data.status == 1) {
                        ...
                        // $scope.showContainer = response.data.status;
            ...
            function getItemIdDetailforOpenrc() {
                ...
                mainFactory.ItemDetail().get({
                    ...
                    if (response.status == 1) {
                        ...
                        console.log($scope.baseElementInfo);
                    } else {
                        alert('Something Wrong!');
