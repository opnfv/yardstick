...
class QemuMigrate(base.Scenario):
    ...
    def setup(self):
        ...
        self.target_script = pkg_resources.resource_filename(
             ...
             Migrate.TARGET_SCRIPT)
        self.host.run("cat > ~/migrate_benchmark.sh",
    ...
    def run(self, result):
        ...
        cmd_args = " %s %s %s %s %s" % (smp, qmp_sock_src, qmp_sock_dst, incoming_ip, migrate_to_port,max_down_time)
