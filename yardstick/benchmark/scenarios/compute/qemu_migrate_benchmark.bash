...
OUTPUT_FILE=/tmp/output_qemu.log
...
output_json()
{
total_time=`cat $OUTPUT_FILE |grep "total time" | cut -d' ' -f3`
downtime=`cat $OUTPUT_FILE |grep "downtime" | cut -d' ' -f2`
setuptime=`cat $OUTPUT_FILE|grep "setup" | cut -d' ' -f2`
echo -e "{ \
