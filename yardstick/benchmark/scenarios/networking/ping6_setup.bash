...
nova list
# disable eth0-VM1 port-security
neutron port-update --no-security-groups eth0-VM1
neutron port-update eth0-VM1 --port-security-enabled=False
neutron port-show eth0-VM1 | grep port_security_enabled
