...
neutron net-create net04_ext --router:external --provider:physical_network physnet --provider:network_type vlan --provider:segmentation_id 1411
neutron subnet-create net04_ext 10.145.140.0/24 --name net04_ext__subnet --allocation-pool start=10.145.140.13,end=10.145.140.20 --disable-dhcp --gateway 10.145.140.1
