...
class Sfc(base.Scenario):  # pragma: no cover
    ...
    def setup(self):
        ...
        self.server = ssh.SSH(target_user, target_ip, password=target_pwd, port=target_ssh_port)
        ...
        self.server = ssh.SSH(SF1_user, SF1_ip, password=SF1_pwd, port=SF1_ssh_port)
        self.server.wait(timeout=600)
        ...
        self.server = ssh.SSH(SF2_user, SF2_ip, password=SF2_pwd, port=SF2_ssh_port)
        self.server.wait(timeout=600)
    ...
    def run(self, result):
        ...
        self.client = ssh.SSH(host_user, host_ip, password=host_pwd, port=ssh_port)
