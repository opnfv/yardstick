...
class NetworkServiceRFC2544(NetworkServiceBase):
    ...
    def __init__(self, scenario_cfg, context_cfg, scenario_output=None):  # pragma: no cover
    ...
    def run(self, result):  # yardstick API
        ...
        while not test_completed:
            ...
            results = self.collector.get_kpi()

            if self._scenario_output is not None:
                self._scenario_output.push_result(results)
