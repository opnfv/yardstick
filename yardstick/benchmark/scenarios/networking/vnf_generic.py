...
class NetworkServiceTestCase(base.Scenario):
    ...
    def _get_traffic_flow(self):
        flow = {}
        try:
            # should be .0  or .1 so we can use list
    ...
    FIND_NETDEVICE_STRING = r"""find /sys/devices/pci* -type d -name net -exec sh -c '{ \
grep -sH ^ $1/ifindex $1/address $1/operstate $1/device/vendor $1/device/device \
