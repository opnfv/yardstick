...
#create classifier
tacker sfc-classifier-create --name sfc1_http --chain chainA --match source_port=0,dest_port=80,protocol=6
tacker sfc-classifier-create --name sfc1_ssh --chain chainA --match source_port=0,dest_port=22,protocol=6
