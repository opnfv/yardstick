...
run_testpmd()
{
    ...
    if [ $NUM_TRAFFIC_PORTS -gt 1 ]; then
        sudo ./destdir/bin/testpmd -c 0x3f -n 4 -b $blacklist -- -a --crc-strip --enable-rx-cksum --nb-cores=4 --coremask=0x3c --rxq=2 --rxd=4096 --rss-udp --txq=2 --forward-mode=rxonly
    else
        sudo ./destdir/bin/testpmd -c 0x0f -n 4 -b $blacklist -- -a --crc-strip --enable-rx-cksum --nb-cores=2 --coremask=0x0c --rxq=2 --rxd=4096 --rss-udp --txq=2 --forward-mode=rxonly
    fi
}
