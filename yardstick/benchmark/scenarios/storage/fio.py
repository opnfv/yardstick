...
class Fio(base.Scenario):
  ...
  Parameters
    ...
    bs - block size used for the io units
        ...
        unit:    bytes
        default: 4k
    rw - type of io patten [read, write, randwrite, randread, rw, randrw]
        type:    string
        unit:    na
        default: write
    ramp_time - run time before logging any performance
        ...
        unit:    seconds
        default: 20
    runtime - run time of fio workload
        type:    int
        unit:    seconds
        default: 30
    ...
    def run(self, args):
        ...
        default_args = "-ioengine=libaio -direct=1 -group_reporting -numjobs=1 -time_based"
        ...
        runtime = options.get("runtime", 30)
        name = "yardstick-fio"
