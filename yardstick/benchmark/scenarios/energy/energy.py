...
class Energy(base.Scenario):
    ...
    def __init__(self, scenario_cfg, context_cfg):
        ...
        self.client = ssh.SSH.from_node(self.target, defaults={"root": "pwd"})
    ...
    def load_chassis_list(self):
        ...
        try:
            chassis_data = json.loads(result)
        ...
        try:
            ...
            LOG.error("Error data format of chassis data or invalid key.")
    ...
    def get_power(self, chassis_uri):
        ...
        try:
            power_metrics = json.loads(result)
        except ValueError as e:
            LOG.error(e)
            power = -1
            return power
        ...
        try:
            ...
            LOG.error("Error data format of power metrics or invalid key.")
            power = -1
