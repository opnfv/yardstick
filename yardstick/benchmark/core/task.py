...
class Task(object):     # pragma: no cover
    ...
    def _run(self, scenarios, run_in_parallel, output_config):
        ...
        for scenario in teardowns:
            self.register_scenarios_error_handler(scenario)
    ...
    def register_scenarios_error_handler(self, scenario_cfg):
        ...
        atexit.register(teardown_error_handler)
