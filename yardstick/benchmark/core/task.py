...
class Task(object):     # pragma: no cover
    ...
    def _get_list_of_dispatchers(self, output_config):
        dispatchers = output_config.get('DEFAULT', {}).get('dispatcher',
                                                           'file')
        out_types = map(str.strip, dispatchers.split(','))
    ...
    def start(self, args, **kwargs):
        ...
        self._get_list_of_dispatchers(output_config)
    ...
    def _get_format_result(self, testcases):
        ...
        info = {
            'deploy_scenario': os.environ.get('SCENARIO', 'unknown'),
