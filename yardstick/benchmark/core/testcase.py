...
class Testcase(object):
    ...
    EXTENDED_SCENARIO_DIR = os.path.join(consts.YARDSTICK_ROOT_PATH,
                                         'yardstick/benchmark/scenarios/extended/')
    ...
    def enable(self, args):
        ...
        extended_testsuite_src = os.path.join(consts.EXTENDED_REPOS_DIR,
        ...
        extended_scenario_src = os.path.join(consts.EXTENDED_REPOS_DIR,
