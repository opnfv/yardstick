...
def _worker_process(queue, cls, method_name, scenario_cfg,
        ...
        if sampled:
            try:
                ...
                if requested_interval > post_adjustment - pre_adjustment:
                    interval = requested_interval - (post_adjustment -
                                                     pre_adjustment)
                else:
                    interval = 0
                ...
                if sla_action == 'assert':
                    ...
                    errors = error.args
            # catch all exceptions because with multiprocessing we can have
            # un-picklable exception problems
            # https://bugs.python.org/issue9400
                ...
                if result:
                    ...
                    # if we do timeout we don't care about dropping individual
                    # KPIs
    ...
    try:
        ...
        # never pass exceptions back to multiprocessing, because some
        # exceptions can be unpicklable
        # https://bugs.python.org/issue9400
        LOG.exception('')
        raise SystemExit(1)
