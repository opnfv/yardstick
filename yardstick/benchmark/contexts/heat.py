...
class HeatContext(Context):
    ...
    def __init__(self):
        ...
        self.yarstick_gen_key_file = True
        self.shade_client = None
    ...
    def init(self, attrs):
        ...
        # looking for external private key
        self.key_filename  = attrs.get("key_filename", None)
        if self.key_filename is not None:
            # Keep the key if it is provided by user
            self.yarstick_gen_key_file = False
    ...
    def deploy(self):
        ...
        # If the external private key is not provided
    ...
    def _delete_key_file(self):
        # Only remove key file if using key generated by yardstick
        # Not remove key file in case using external key_filename.
        if self.yarstick_gen_key_file:
            try:
