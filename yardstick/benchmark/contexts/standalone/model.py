...
class Libvirt(object):
    ...
    def gen_cdrom_image(connection, file_path, key_filename, xml_str, vm_user):
        ...
        cmd_lst = [
            ...
            META_DATA_TEMPLATE.format(meta_file=meta_data, host=hostname, uuid=uuid),
            USER_DATA_TEMPLATE.format(user_file=user_data, user_config=user_conf),
...
class StandaloneContextHelper(object):
    ...
    def check_update_key(cls, connection, node, xml_str, name, cdrom_img):
        ...
        Libvirt.gen_cdrom_image(connection, cdrom_img, key_filename, xml_str, user_name)
        return node
