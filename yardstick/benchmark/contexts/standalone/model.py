...
class Libvirt(object):
    ...
    def add_ovs_interface(self, vpath, port_num, vpci, vports_mac, xml):
        ...
        self.add_interface_address(interface, pci_address)
    ...
    def add_sriov_interfaces(self, vm_pci, vf_pci, vfmac, xml):
        ...
        self.add_interface_address(interface, pci_vm_address)
    ...
    def build_vm_xml(self, connection, flavor, cfg, vm_name, index):
        ...
        image = self.create_snapshot_qemu(connection, index,
...
class StandaloneContextHelper(object):
    ...
    def get_mgmt_ip(self, connection, mac, cidr, node):
        mgmtip = None
        times = 10
