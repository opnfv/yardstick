...
class _TrafficGenMQConsumer(vnf_base.GenericTrafficGen,
    ...
    def __init__(self, name, vnfd, task_id):  # pragma: no cover
    ...
    def run_traffic(self, *args):  # pragma: no cover
        pass
    ...
    def instantiate(self, *args):  # pragma: no cover
        pass

    def scale(self, flavor=''):  # pragma: no cover
        pass

    def runner_method_start_iteration(self, ctxt, **kwargs):  # pragma: no cover
...
class _DummyProducer(producer.MessagingProducer):  # pragma: no cover
    pass


class GenericVNFMQConsumerTestCase(ft_base.BaseFunctionalTestCase):

    def test_fistro(self):  # pragma: no cover
