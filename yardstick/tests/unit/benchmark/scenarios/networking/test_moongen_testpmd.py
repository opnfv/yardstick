...
class MoongenTestPMDTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._mock_ssh = mock.patch(
            'yardstick.benchmark.scenarios.networking.MoongenTestPMD.ssh')
    ...
    def test_moongen_testpmd_generate_config_file(self, _, mock_subprocess):
        p = moongen_testpmd.MoongenTestPMD(self.TestPMDargs, self.ctx)
    ...
    def test_moongen_testpmd_result_to_data_match(self, _, mock_subprocess):
        p = moongen_testpmd.MoongenTestPMD(self.TestPMDargs, self.ctx)
        ...
        p.generate_config_file(result=result, frame_size=0)
        self.assertTrue(p.TO_DATA)

    def test_moongen_testpmd_result_to_data_not_match(self, _, mock_subprocess):
        p = moongen_testpmd.MoongenTestPMD(self.TestPMDargs, self.ctx)
