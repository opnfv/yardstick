...
from yardstick.benchmark.scenarios.networking.pktgen_dpdk import \
    PktgenDPDKLatency
...
class PktgenDPDKLatencyTestCase(unittest.TestCase):
    ...
    def test_pktgen_dpdk_successful_setup(self):
        scenario = PktgenDPDKLatency(self.scenario_cfg, self.context_cfg)
        scenario.setup()
    ...
    def test_pktgen_dpdk_successful_get_port_ip(self):
        ...
        utils.get_port_ip(scenario.server, "eth1")
    ...
    def test_pktgen_dpdk_successful_get_port_mac(self):
        ...
        utils.get_port_mac(scenario.server, "eth1")
    ...
    def test_pktgen_dpdk_successful_sla(self):
        ...
        scenario.scenario_cfg['sla'] = {'max_latency': 100}
    ...
    def test_pktgen_dpdk_unsuccessful_sla(self):
        ...
        self.mock_SSH.from_node().execute.return_value = (0, sample_output, '')
        result = {}
        self.assertRaises(AssertionError, scenario.run, result)
    ...
    def test_pktgen_dpdk_run_unsuccessful_get_port_mac(self):
        ...
        self.mock_SSH.from_node().execute.return_value = (1, '', 'FOOBAR')
        result = {}
        self.assertRaises(RuntimeError, scenario.run, result)
