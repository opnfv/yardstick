...
class VsperfTestCase(unittest.TestCase):
    ...
    def test_vsperf_run_ok_setup_not_done(self):
        self.mock_SSH.from_node().execute.return_value = (
            0, 'throughput_rx_fps\r\n14797660.000\r\n', '')
    ...
    def test_vsperf_run_failed_vsperf_execution(self):
    ...
    def test_vsperf_run_failed_csv_report(self):
        self.mock_SSH.from_node().execute.side_effect = ((0, '', ''),
                                                         (0, '', ''),
                                                         (1, '', ''))
    ...
    def test_vsperf_run_sla_fail(self):
        self.mock_SSH.from_node().execute.return_value = (
            0, 'throughput_rx_fps\r\n123456.000\r\n', '')
    ...
    def test_vsperf_run_sla_fail_metric_not_collected(self):
        self.mock_SSH.from_node().execute.return_value = (
    ...
    def test_vsperf_run_sla_fail_metric_not_defined_in_sla(self):
