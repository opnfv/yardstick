...
class StorPerfTestCase(unittest.TestCase):
    ...
    @mock.patch.object(requests, 'get')
    def test_unsuccessful_setup_state(self, mock_get):
    ...
    @mock.patch.object(requests, 'post')
    @mock.patch.object(requests, 'get')
    def test_failed_setup(self, mock_get, mock_post):
    ...
    @mock.patch.object(requests, 'get')
    @mock.patch.object(requests, 'post')
    def test_successful_v1_run(self, mock_post, mock_get):
    ...
    @mock.patch.object(requests, 'get')
    @mock.patch.object(requests, 'post')
    def test_successful_v2_run(self, mock_post, mock_get):
        mock_post.side_effect = mocked_requests_job_post
        mock_get.side_effect = mocked_requests_job_get
    ...
    def test_failed_run(self, mock_sleep, mock_post, mock_get):
    ...
    @mock.patch('time.sleep')
    def test_run_calls_setup(self, mock_sleep,
                             mock_setup, mock_post, mock_get):
        mock_sleep.return_value = None
    ...
    @mock.patch.object(requests, 'post')
    @mock.patch('time.sleep')
    def test_successful_initialize(self, mock_sleep, mock_post, mock_get):
        mock_sleep.return_value = None
        mock_post.side_effect = mocked_requests_job_post
        mock_get.side_effect = mocked_requests_job_get
    ...
    @mock.patch.object(requests, 'post')
    @mock.patch('time.sleep')
    def test_failed_initialize(self, mock_sleep, mock_post, mock_get):
        mock_sleep.return_value = None
