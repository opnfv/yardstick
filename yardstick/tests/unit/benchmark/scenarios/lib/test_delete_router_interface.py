...
class DeleteRouterInterfaceTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.result = {"delete_router_interface": 0}
    ...
    def test_run(self):
        ...
        self.assertDictEqual({"delete_router_interface": 1}, self.result)
    ...
    def test_run_fail(self):
        ...
        self.assertDictEqual({"delete_router_interface": 0}, self.result)
