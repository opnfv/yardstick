...
class DeleteRouterInterfaceTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_remove_router_interface = self.\
            _mock_remove_router_interface.start()
        ...
        self.args = {'options': {'router': _uuid}}
    ...
    def test_run(self):
        ...
        self.assertTrue(self._delrout_obj.run({}))
    ...
    def test_run_fail(self):
        ...
        self.assertFalse(self._delrout_obj.run({}))
