...
class CreateFloatingIpTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self._mock_get_network_id = mock.patch.object(
            openstack_utils, 'get_network_id')
        ...
        self.result = {"floating_ip_create": 0}
    ...
    def test_run(self):
        ...
        self.assertDictEqual({"floating_ip_create": 1}, self.result)
    ...
    def test_run_no_fip(self):
        ...
        self.assertDictEqual({"floating_ip_create": 0}, self.result)
