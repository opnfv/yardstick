...
class NodeContextTestCase(unittest.TestCase):
    ...
    def test__get_server_duplicate(self):
        ...
        with self.assertRaises(ValueError):
            self.test_context._get_server('node1.foo')

    def test__get_server_found(self):

        self.test_context.init(self.attrs)

        result = self.test_context._get_server('node1.foo')
    ...
    def test_get_server_server_not_in_context(self):
        ...
        with self.assertRaises(ValueError):
            self.test_context.get_server('my.vnf1-12345678')
    ...
    def test_get_context_from_server(self):
        ...
        self.assertIs(self.test_context.get_context_from_server('my.vnf1'),
                      self.test_context)
