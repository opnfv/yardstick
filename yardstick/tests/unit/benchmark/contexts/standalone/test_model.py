...
"""Unittests for yardstick.benchmark.contexts.standalone.model"""
...
class ModelLibvirtTestCase(unittest.TestCase):
    ...
    def test_check_if_vm_exists_and_delete(self):
        ...
        # TODO: Check states/function calls
    ...
    @mock.patch(
       "yardstick.benchmark.contexts.standalone.model.Libvirt.update_interrupts_hugepages_perf")
...
class StandaloneContextHelperTestCase(unittest.TestCase):
    ...
    def test_install_req_libs(self):
        with mock.patch("yardstick.ssh.SSH") as ssh:
            ...
            ssh.return_value = ssh_mock
        self.assertIsNone(StandaloneContextHelper.install_req_libs(ssh_mock))
    ...
    def test_parse_pod_file(self):
        ...
        self.helper.file_path = self._get_file_abspath(self.NODE_SAMPLE)
        self.assertRaises(
            TypeError, self.helper.parse_pod_file, self.helper.file_path)
    ...
    def test_get_mgmt_ip(self, mock_ssh):
        with mock.patch("yardstick.ssh.SSH") as ssh:
            ...
            ssh.return_value = ssh_mock
        status = StandaloneContextHelper.get_mgmt_ip(
