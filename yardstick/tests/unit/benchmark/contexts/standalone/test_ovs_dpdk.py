...
"""Unittests for yardstick.benchmark.contexts.standalone.ovs_dpdk"""
...
class OvsDpdkContextTestCase(unittest.TestCase):
    ...
    #TODO: Split this test for networks that exist and networks that don't
    def test__get_network(self):
        ...
        attr_name = 'vld777' # pylint: disable=redefined-variable-type
        self.assertIsNone(self.ovs_dpdk._get_network(attr_name))
