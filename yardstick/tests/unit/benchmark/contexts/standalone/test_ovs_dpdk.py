...
class OvsDpdkContextTestCase(unittest.TestCase):
    ...
    def test_setup_ovs_dpdk_context(self, mock_create_vm, mock_check_if_exists, mock_build_xml,
                                    mock_write_file, mock_gen_cdrom_image, mock_add_cdrom, mock_check_update_key):
        self.ovs_dpdk.vm_deploy = True
        self.ovs_dpdk.connection = mock.Mock()
        self.ovs_dpdk.vm_names = ['vm_0', 'vm_1']
        self.ovs_dpdk.drivers = []
        ...
        key_filename = '/tmp/git/yardstick/yardstick/resources/files/yardstick_key-fake_name'
        ...
        mock_check_update_key.assert_called_once_with(self.ovs_dpdk.connection, vnf_instance, xml_str, key_filename)
