...
class ReportTestCase(unittest.TestCase):
    ...
    def test__create_node(self):
        id = "tg__0.DropPackets"
        self.rep.created_nodes = []
        self.rep.jstree_data = []

        expected_data = [
            {"id": "tg__0", "text": "tg__0", "parent": "#"},
            {"id": "tg__0.DropPackets", "text": "DropPackets", "parent": "tg__0"}
        ]
        self.rep._create_node(id)

        self.assertEqual(self.rep.created_nodes, ['tg__0', 'tg__0.DropPackets'])
        self.assertEqual(self.rep.jstree_data, expected_data)
    ...
    def test_format_for_jstree(self):
        ...
        result = self.rep.format_for_jstree(data)
