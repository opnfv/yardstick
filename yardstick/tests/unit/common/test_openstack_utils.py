...
class CreateKeypairTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.mock_shade_client = mock.Mock()
        self.name = 'key_name'
        self.mock_shade_client.create_keypair = mock.Mock()
...
class DeleteKeypairTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.mock_shade_client = mock.Mock()
        self.mock_shade_client.delete_keypair = mock.Mock()
...
class AttachVolumeToServerTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.mock_shade_client = mock.Mock()
        self.server = {'name': 'server-name', 'id': 'server001'}
        self.volume = {'name': 'volume_name', 'id': 'volume001'}
        self.mock_shade_client.attach_volume = mock.Mock()

    def test_attach_volume_to_server(self):
        self.mock_shade_client.attach_volume.return_value = (
            {'server_id': 'server001', 'volumeId': 'volume001'})
