...
class ReadMeminfoTestCase(unittest.TestCase):
    ...
    MEMINFO = ('MemTotal:       65860500 kB\n'
               'MemFree:        28690900 kB\n'
               'MemAvailable:   52873764 kB\n'
               'Active(anon):    3015676 kB\n'
               'HugePages_Total:       8\n'
    ...
    def test_read_meminfo(self):
        ...
        with mock.patch.object(ssh_client, 'get_file_obj') as \
                mock_get_client, \
                mock.patch.object(six.BytesIO, 'getvalue') as mock_getvalue:
            mock_getvalue.return_value = self.MEMINFO
