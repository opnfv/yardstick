...
class TestReceiveRateMeasurement(unittest.TestCase):
    ...
    def test__init__(self):
        ...
        self.assertEqual(0.017492087745986023, measured.loss_fraction)

    def test___str__(self):
        measured = ReceiveRateMeasurement(1, 4857361, 4857339, 84965)
        self.assertEqual('d=1.0,Tr=4857361.0,Df=0.017492087746',
                         measured.__str__())

    def test___repr__(self):
        measured = ReceiveRateMeasurement(1, 4857361, 4857339, 84965)
        self.assertEqual(
            'ReceiveRateMeasurement(duration=1.0,target_tr=4857361.0,transmit_count=4857339,loss_count=84965)',
            measured.__repr__())
