...
class TestNdrPdrResult(unittest.TestCase):
    ...
    def test_width_in_goals(self):
        ...
        starting_interval = ReceiveRateInterval(measured_low, measured_high)
        ndrpdr_result = NdrPdrResult(starting_interval, starting_interval)
        self.assertEqual('ndr 4.86797498394; pdr 4.86797498394',
    ...
    def test___str__(self):
        ...
        ndrpdr_result = NdrPdrResult(starting_interval, starting_interval)
        self.assertEqual(
            'NDR=[d=1.0,Tr=4857361.0,Df=0.017492087746;d=1.0,Tr=4977343.0,Df=0.0241011226925);'
            'PDR=[d=1.0,Tr=4857361.0,Df=0.017492087746;d=1.0,Tr=4977343.0,Df=0.0241011226925)',
    ...
    def test___repr__(self):
        ...
        ndrpdr_result = NdrPdrResult(starting_interval, starting_interval)
        self.assertEqual(
            'NdrPdrResult(ndr_interval=ReceiveRateInterval(measured_low=ReceiveRateMeasurement(duration=1.0,target_tr=4857361.0,transmit_count=4857339,loss_count=84965),measured_high=ReceiveRateMeasurement(duration=1.0,target_tr=4977343.0,transmit_count=4977320,loss_count=119959)),pdr_interval=ReceiveRateInterval(measured_low=ReceiveRateMeasurement(duration=1.0,target_tr=4857361.0,transmit_count=4857339,loss_count=84965),measured_high=ReceiveRateMeasurement(duration=1.0,target_tr=4977343.0,transmit_count=4977320,loss_count=119959)))',
