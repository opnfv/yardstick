...
class TestVppRFC2544Profile(base.BaseUnitTestCase):
    ...
    def test__create_imix_data_mode_DIB(self):
        ...
        self.assertEqual(
            {'64': int(64 * 25.0 * 100 / byte_total),
             '128': int(128 * 25.0 * 100 / byte_total),
             '512': int(512 * 25.0 * 100 / byte_total),
             '1518': int(1518 * 25.0 * 100 / byte_total)},
            rfc2544_profile._create_imix_data(
    ...
    def test__create_single_stream(self, mock_stream, mock_txcont,
        ...
        with mock.patch.object(vpp_rfc2544_profile, '_create_single_packet') as \
            ...
            output = vpp_rfc2544_profile._create_single_stream(port, imix_data,
                                                               100, 0.0)
    ...
    def test_binary_search(self):
        ...
        mock_generator.vnfd_helper.interfaces = [
            {"name": "enp129s0f0"}, {"name": "enp129s0f1"}
        ]
        stats = {
            "0": {
                "ibytes": 55549120,
        ...
        expected = {'Result_theor_max_throughput': 134126008.0,
                    'enp129s0f0': {'Result_Actual_throughput': 104339032.0},
                    'enp129s0f1': {'Result_Actual_throughput': 134119648.0}}
