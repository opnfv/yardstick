...
class TestAclApproxSetupEnvSetupEnvHelper(unittest.TestCase):
    ...
    def test_get_default_flows(self):
        ...
        self.check_acl_commands(setup_helper.get_flows_config(), [
            # format: (<cli pattern>, <number of excpected matches>)
    ...
    def check_acl_commands(self, config, expected_cli_patterns):
        """Check if expected ACL CLI commads (given as a list of patterns,
        ...
        # the example ACL config above with the configuration retuned by
        # get_flows_config() function. It's more correct toause CLI patterns
