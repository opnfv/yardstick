...
class TestIxLoadTrafficGen(unittest.TestCase):
    ...
    def setUp(self):
        self._mock_call = mock.patch("subprocess.call")
    ...
    @mock.patch("yardstick.ssh.SSH")
    def test_listen_traffic(self, mock_ssh):
        mock_ssh.from_node.execute.return_value = 0, "", ""
    ...
    @mock.patch("yardstick.network_services.vnf_generic.vnf.tg_ixload.find_relative_file")
    ...
    @mock.patch("yardstick.ssh.SSH")
    def test_instantiate(self, mock_ssh, *args):
        mock_ssh.from_node.execute.return_value = 0, "", ""
        mock_ssh.from_node.run.return_value = 0, "", ""
    ...
    @mock.patch("yardstick.network_services.vnf_generic.vnf.tg_ixload.shutil")
    @mock.patch("yardstick.ssh.SSH")
    def test_run_traffic(self, mock_ssh, *args):
    ...
    @mock.patch("yardstick.network_services.vnf_generic.vnf.tg_ixload.shutil")
    @mock.patch("yardstick.ssh.SSH")
    def test_run_traffic_csv(self, mock_ssh, *args):
        mock_traffic_profile = mock.Mock(autospec=TrafficProfile)
        mock_traffic_profile.get_traffic_definition.return_value = "64"
        mock_traffic_profile.params = self.TRAFFIC_PROFILE
    ...
    @mock.patch("yardstick.ssh.SSH")
    def test_terminate(self, mock_ssh):
        vnfd = self.VNFD['vnfd:vnfd-catalog']['vnfd'][0]
        mock_ssh.from_node.execute.return_value = 0, "", ""
