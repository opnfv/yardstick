...
from yardstick.network_services.vnf_generic.vnf import base, sample_vnf, tg_vpp
...
class TestTrexVppResourceHelper(unittest.TestCase):
    ...
    def test_fmt_latency(self):
        ...
        vpp_rfc = tg_vpp.TrexVppResourceHelper(mock_setup_helper)
...
class TestTrexTrafficGenVpp(unittest.TestCase):
                ...
                "external-interface": [
                    {
                        ...
                        "vnfd-connection-point-ref": "enp129s0f0"
                    },
                    {
                        "name": "enp129s0f1",
                        "virtual-interface": {
                        ...
                        "vnfd-connection-point-ref": "enp129s0f1"
                    }
                ],
    ...
    def test___init__(self):
        trex_traffic_gen = tg_vpp.TrexTrafficGenVpp(
            'tg0', self.VNFD_0, 'task_id')
