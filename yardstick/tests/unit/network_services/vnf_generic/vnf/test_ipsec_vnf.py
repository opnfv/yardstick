...
class TestVipsecApproxVnf(unittest.TestCase):
                        ...
                        "external-interface": [
                            {
                                ...
                                "vnfd-connection-point-ref": "ens6"
                            },
                            {
                                "name": "ens7",
                                "virtual-interface": {
    ...
    def test___init__(self, *args):
        ...
        vipsec_vnf = ipsec_vnf.VipsecApproxVnf(name, vnfd, 'task_id')
...
class TestVipsecApproxSetupEnvHelper(unittest.TestCase):
    ...
    VPP_INTERFACES_STATUS = '              Name               Idx    State  MTU (L3/IP4/IP6/MPLS)     Counter          Count     \n' \
    ...
    def test_calculate_frame_size(self):
        ...
        ipsec_approx_setup_helper = VipsecApproxSetupEnvHelper(vnfd_helper,
                                                               ssh_helper,
                                                               scenario_helper)
        self.assertEqual(353, ipsec_approx_setup_helper.calculate_frame_size(
    ...
    def test_get_vpp_statistics(self):
        def execute(cmd):
            if 'TenGigabitEthernetff/6/0' in cmd:
                return 0, output_ens6, ''
            elif 'VirtualFunctionEthernetff/7/0' in cmd:
                return 0, output_ens7, ''
            return 0, '0', ''

        output_ens6 = '              Name               Idx    State  MTU (L3/IP4/IP6/MPLS)     Counter          Count     \n' \
                      ...
                      '                                                                    ip4                     23373568\n' \
                      '                                                                    rx-miss                 27789925'
        output_ens7 = '              Name               Idx    State  MTU (L3/IP4/IP6/MPLS)     Counter          Count     \n' \
        ...
        with mock.patch.object(cpu.CpuSysCores, 'get_cpu_layout') as \
            ...
            ipsec_approx_setup_helper.update_vpp_interface_data()
            ipsec_approx_setup_helper.iface_update_numa()
        self.assertEqual({'ens6': {'packets_dropped': 27789925,
                                   'packets_fwd': 20476416,
                                   'packets_in': 23373568},
                          'ens7': {'packets_dropped': 27789925,
                                   'packets_fwd': 20476416,
                                   'packets_in': 23373568}},
    ...
    def test_parser_vpp_stats(self):
        ...
        self.assertEqual({'ens6': {'packets_dropped': 27789925,
                                   'packets_fwd': 20476416,
                                   'packets_in': 23373568}},
                         ipsec_approx_setup_helper.parser_vpp_stats('ens6',
