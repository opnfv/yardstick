...
class TestVipsecApproxSetupEnvHelper(unittest.TestCase):
    ...
    VPP_INTERFACES_STATUS_FALSE = '              Name               Idx    State  MTU (L3/IP4/IP6/MPLS)     Counter          Count     \n' \
    ...
    def test_get_vpp_statistics(self):
        ...
        output_xe0 = '              Name               Idx    State  MTU (L3/IP4/IP6/MPLS)     Counter          Count     \n' \
                     ...
                     '                                                                    ip4                     23373568\n' \
                     '                                                                    rx-miss                 27789925'
        output_xe1 = '              Name               Idx    State  MTU (L3/IP4/IP6/MPLS)     Counter          Count     \n' \
    ...
    def test_parser_vpp_stats_no_miss(self):
        output = '              Name               Idx    State                            Counter          Count     \n' \
