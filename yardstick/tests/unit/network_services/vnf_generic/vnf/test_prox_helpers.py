...
class TestProxSocketHelper(unittest.TestCase):
    ...
    # TODO: Split this into three tests
...
class TestProxDpdkVnfSetupEnvHelper(unittest.TestCase):
    ...
    # TODO: Split this into several smaller tests
    # pylint: disable=redefined-variable-type
...
class TestProxResourceHelper(unittest.TestCase):
    ...
    def test_execute(self):
        ...
        # TODO: Make this a separate test: test_execute_no_client
        helper.client = object() # pylint: disable=redefined-variable-type
...
class TestProxProfileHelper(unittest.TestCase):
    ...
    # TODO: Split this test; there are two sets of inputs/outputs
    # pylint: disable=redefined-variable-type
