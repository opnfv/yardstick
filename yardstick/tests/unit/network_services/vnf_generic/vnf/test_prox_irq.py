...
class TestProxIrqVNF(unittest.TestCase):
    ...
    def test_collect_kpi(self, ssh, *args):
        ...
        result = prox_irq_vnf.collect_kpi()
        self.assertEqual(result["collect_stats"]['core_2']['bucket_10'], 'None')
        self.assertEqual(result["collect_stats"]['core_2']['bucket_11'], 'None')
        self.assertEqual(result["collect_stats"]['core_2']['bucket_12'], 'None')
