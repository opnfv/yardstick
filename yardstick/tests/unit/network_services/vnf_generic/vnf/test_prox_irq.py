...
class TestProxIrqVNF(unittest.TestCase):
    ...
    def test_collect_kpi(self, ssh, *args):
        ...
        resource_helper.execute.return_value = ([[0, 1, 3, 4],
                                                 [0, 1, 2, 3, 4, 5]])
        ...
        self.assertListEqual(result["collect_stats"], resource_helper.execute.return_value)
...
class TestProxIrqGen(unittest.TestCase):
    ...
    def test_collect_kpi(self, ssh, *args):
        ...
        vnfd = self.VNFD['vnfd:vnfd-catalog']['vnfd'][0]
        resource_helper = mock.MagicMock()
        resource_helper.sut.irq_core_stats.return_value = ([[0, 1, 3, 4],
                                                 [0, 1, 2, 3, 4, 5]])
        ...
        self.assertListEqual(result["collect_stats"], resource_helper.sut.irq_core_stats.return_value)
