...
class TestSippVnf(unittest.TestCase):
    ...
    QUEUE = {'timestamp': 1000.0, 'reg': 100.0, 'reg_saps': 0.0}
    ...
    def test_handle_result_files(self):
        result_deque = deque([{'timestamp': 1000.0, 'reg': 100.0, 'reg_saps': 0.0}])
        file = "/tmp/test.txt"
    ...
    def test_run_traffic(self):
        mock_traffic_profile = mock.Mock(autospec=sip.SipProfile)
        mock_traffic_profile.params = self.TRAFFIC_PROFILE
        self.sipp_vnf.ssh_helper = mock.Mock()
        self.sipp_vnf.run_traffic(sip.SipProfile)
    ...
    def test_collect_kpi(self):
        result_deque = deque([{'timestamp': 1000.0, 'reg': 100.0, 'reg_saps': 0.0}])
        self.sipp_vnf.handle_result_files = mock.Mock(return_value=result_deque)
