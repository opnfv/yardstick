...
class TestSippVnf(unittest.TestCase):
    ...
    def test___init__(self, *args):
        sipp_vnf = tg_imsbench_sipp.SippVnf('tg__0', self.VNFD)
    ...
    def test_get_result_files(self):
        self.assertIsNone(self.sipp_vnf.get_result_files())

    def test_handle_result_files(self):
        self.assertIsNone(self.sipp_vnf.handle_result_files())

    def test_run_traffic(self):
        self.assertIsNone(self.sipp_vnf.run_traffic())

    def test_collect_kpi(self):
        self.assertIsNone(self.sipp_vnf.collect_kpi())

    def test_is_ended(self):
        self.assertIsNone(self.sipp_vnf.is_ended())
