...
class TestIxNextgen(unittest.TestCase):
    ...
    @mock.patch.object(ixnet_api.IxNextgen, '_create_flow_groups')
    @mock.patch.object(ixnet_api.IxNextgen, '_setup_config_elements')
    @mock.patch.object(ixnet_api.IxNextgen, '_set_flow_tracking')
    def test_create_ipv4_traffic_model(self, mock__set_flow_tracking,
                                       mock__setup_config_elements,
                                       mock__create_flow_groups,
                                       mock__create_traffic_item):
        ...
        mock__set_flow_tracking.assert_called_once_with(
    ...
    def test_get_pppoe_scenario_statistics(self, mock_get_view):
        ...
        # pppoe_scenario_stats_map = OrderedDict([
        #     ('port_statistics', {'port_1': 'Port 1', 'port_2': 'Port 2'}),
        #     ('flow_statistic', {'flow_1': 'Flow 1', 'flow_2': 'Flow 2'}),
        #     ('pppox_client_per_port', {'sub_1': 'Sub 1', 'sub_2': 'Sub 2'})
        # ])
