...
class RFC2544ThroughputBenchmarkRunTest(unittest.TestCase):
    ...
    @mock.patch('experimental_framework.benchmarks.rfc2544_throughput_benchmark.RFC2544ThroughputBenchmark.'
                '_reset_lua_file')
    @mock.patch('experimental_framework.benchmarks.rfc2544_throughput_benchmark.RFC2544ThroughputBenchmark.'
                '_configure_lua_file')
    @mock.patch('experimental_framework.benchmarks.rfc2544_throughput_benchmark.RFC2544ThroughputBenchmark.'
    ...
    @mock.patch('experimental_framework.benchmarks.rfc2544_throughput_benchmark.RFC2544ThroughputBenchmark.'
                '_get_results')
    @mock.patch('experimental_framework.benchmarks.rfc2544_throughput_benchmark.dpdk.DpdkPacketGenerator')
    def test_run_for_success(self, mock_dpdk, mock_get_results, mock_extract_size, conf_lua_file_mock,
                             reset_lua_file_mock):
