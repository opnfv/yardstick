        ...
        for core in core_details:
            for k, v in core.items():
                if k == "physical id":
                    ...
                    self.core_map[core['physical id']].append(core["processor"])

        return self.core_map

    def validate_cpu_cfg(self, vnf_cfg={'lb_config': 'SW', 'lb_count': 1, 'worker_config':
        ...
        if vnf_cfg['lb_config'] == 'SW':
            ...
            if self.core_map["cores_per_socket"] < num_cpu:
                return -1
