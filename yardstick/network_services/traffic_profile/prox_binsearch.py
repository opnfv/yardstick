    ...
    def run_test_with_pkt_size(self, traffic_gen, pkt_size, duration):
        ...
        for test_value in self.bounds_iterator(LOG):
            ...
            if result.success:
                ...
                success_samples["Success_rx_total"] = result.rx_total / duration
                success_samples["Success_tx_total"] = result.tx_total / duration
                success_samples["Success_can_be_lost"] = result.can_be_lost / duration
                success_samples["Success_drop_total"] = result.drop_total / duration
