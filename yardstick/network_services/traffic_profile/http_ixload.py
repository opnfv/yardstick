...
""", timestamp, stats)
    ...
    def get_ixload_obj(self):
        from IxLoad import IxLoad, StatCollectorUtils
        return [IxLoad(), StatCollectorUtils()]

    def start_http_test(self):
        ixLoad_obj = self.get_ixload_obj()
        self.ixLoad = ixLoad_obj[0]
