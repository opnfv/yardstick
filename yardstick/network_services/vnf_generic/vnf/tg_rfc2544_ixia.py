...
class IxiaResourceHelper(ClientResourceHelper):
    ...
    def __init__(self, setup_helper, rfc_helper_type=None):
        ...
        if not IxNextgen:
            raise RuntimeError('Could not load IxNextgen')

        self.client = None
        self.client_file_name = str(self.scenario_helper['ixia_profile'])
    ...
    def _connect(self, client=None):
        ...
        self.client.connect(self.vnfd_helper.vnfd)
    ...
    def run_traffic(self, traffic_profile):
        ...
        self.client.ix_load_config(self.client_file_name)
        ...
        for index, interface in enumerate(self.vnfd_helper.interfaces):
            ...
            mac["src_mac_{}".format(index)] = virt_intf["local_mac"]
            mac["dst_mac_{}".format(index)] = virt_intf["dst_mac"]
