...
class TrexResourceHelper(ClientResourceHelper):
    ...
    def generate_cfg(self):
        ...
        sorted_ports = ((self.vnfd_helper.port_num(port_name), port_name) for port_name in port_names)
        for index, (port_name, port_num) in enumerate(sorted_ports):
            interface = self.vnfd_helper.find_interface(port_name)
