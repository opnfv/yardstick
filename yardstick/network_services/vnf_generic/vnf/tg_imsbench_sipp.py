...
from yardstick.network_services.vnf_generic.vnf.sample_vnf \
     import SampleVNFTrafficGen
from yardstick.network_services.vnf_generic.vnf.sample_vnf \
     import SetupEnvHelper
from yardstick.network_services.vnf_generic.vnf.sample_vnf \
     import ClientResourceHelper
...
class SippVnf(SampleVNFTrafficGen):
    ...
    def __init__(self, name, vnfd, task_id, setup_env_helper_type=None,
        ...
        self.params = ""
        self.influxdb_url = ""
        pcscf_intf = self.vnfd_helper.interfaces[0]["virtual-interface"]\
                     ["peer_intf"]["vnf__0"]
