...
class InfluxDBHelper(object):
    ...
    def __init__(self, vcmts_influxdb_ip, vcmts_influxdb_port):
        self._read_client = InfluxDBClient(host=vcmts_influxdb_ip,
                                           port=vcmts_influxdb_port,
                                           database='collectd')
    ...
    def _is_float_measurement(self, measurement):
        return measurement == 'cpu_value' or \
               measurement == 'intel_rdt_value' or \
               measurement == 'turbostat_value' or \
               measurement == 'downstream_value' or \
    ...
    def _rw_measurment(self, measurement, columns):
        ...
        query_result = query_result[measurement]
        for entry in query_result:
            ...
            for column in columns:
                if column == 'value' and self._is_float_measurement(measurement):
