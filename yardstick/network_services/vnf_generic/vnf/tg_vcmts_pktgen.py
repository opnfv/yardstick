...
class VcmtsPktgenResourceHelper(ClientResourceHelper):
    ...
    def run_traffic(self, traffic_profile, *args):
        self.pktgen_helper = PktgenHelper(self.setup_helper.pktgen_address,
        ...
        LOG.info("Connected to pktgen instance at %s", self.setup_helper.pktgen_address)
