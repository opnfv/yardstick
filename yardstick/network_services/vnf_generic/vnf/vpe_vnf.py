...
class VpeApproxSetupEnvHelper(DpdkVnfSetupEnvHelper):
    ...
    def build_config(self):
        ...
        script_file = vnf_cfg.get('script_file', self.CFG_SCRIPT)
        vpe_vars = {
        ...
        if script_file == self.CFG_SCRIPT:
        ...
        self._build_pipeline_kwargs(cfg_file='/tmp/' + config_basename, script='/tmp/' + script_basename)
