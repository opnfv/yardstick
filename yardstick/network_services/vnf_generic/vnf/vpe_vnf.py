...
class ConfigCreate(object):
    ...
    def __init__(self, vnfd_helper, socket):
        ...
        self.socket = socket
        self._dpdk_port_to_llink_map = None
    ...
    def dpdk_port_to_link_id_map(self):
        ...
        if self._dpdk_port_to_llink_map is None:
            self._dpdk_port_to_llink_map = {}
            for llink_id, port_name in enumerate(sorted(self.vnfd_helper.port_pairs.all_ports,
                                                        key=self.vnfd_helper.port_num)):
                self._dpdk_port_to_llink_map[port_name] = llink_id
        return self._dpdk_port_to_llink_map
