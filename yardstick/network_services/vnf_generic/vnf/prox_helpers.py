...
class ProxSocketHelper(object):
    ...
    def set_pps(self, cores, pps, pkt_size, line_speed):
...
class ProxProfileHelper(object):
    ...
    def run_test(self, pkt_size, duration, value, line_speed, tolerated_loss=0.0):
        data_helper = ProxDataHelper(self.vnfd_helper, self.sut, pkt_size, value, line_speed, tolerated_loss)
