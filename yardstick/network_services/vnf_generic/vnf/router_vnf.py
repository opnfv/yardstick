...
class RouterVNF(GenericVNF):
    ...
    def instantiate(self, scenario_cfg, context_cfg):
        ...
        self.deploy_helper.deploy_vnfs("RouterVNF")
...
class RouterVNFTrafficGen(GenericTrafficGen):
    ...
    def __init__(self, name, vnfd, setup_env_helper_type=None, resource_helper_type=None):
        super(RouterVNFTrafficGen, self).__init__(name, vnfd)
