...
class IxNextgen(object):
    ...
    def create_traffic_item(self):
        ...
        quick_flow_group = self.ixnet.add(self.ixnet.getRoot() + '/traffic',
                                          'trafficItem')
        self.ixnet.setMultiAttribute(quick_flow_group, '-name', 'RFC2455',
                                     '-trafficType', 'raw')
        self.ixnet.commit()

        quick_flow_group_id = self.ixnet.remapIds(quick_flow_group)[0]
        ...
        for up, down in zip(uplink_ports, downlink_ports):
            ...
            endpoint_set_1 = self.ixnet.add(quick_flow_group_id, 'endpointSet')
            endpoint_set_2 = self.ixnet.add(quick_flow_group_id, 'endpointSet')
            self.ixnet.setMultiAttribute(
                endpoint_set_1,
        ...
        self.ixnet.setAttribute(
            quick_flow_group_id + '/configElement:1/frameRateDistribution',
        ...
        self.ixnet.setAttribute(quick_flow_group_id + '/tracking',
